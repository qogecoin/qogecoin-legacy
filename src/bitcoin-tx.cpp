...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s qogecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  qogecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qogecoin transaction") + "\n" +
              "  qogecoin-tx [options] -create [commands]   " + _("Create hex-encoded qogecoin transaction") + "\n" +
              "\n";
