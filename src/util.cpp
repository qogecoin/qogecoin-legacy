...
const char * const BITCOIN_CONF_FILENAME = "qogecoin.conf";
const char * const BITCOIN_PID_FILENAME = "qogecoin.pid";
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Bitcoin Core") == std::string::npos) {
        ...
        strYear.replace(strYear.find("2021"), sizeof("2011")-1, "2009");
