...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("qogecoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "qogecoin:");
    }
...
{
    QString ret = QString("qogecoin:%1").arg(info.address);
    int paramCount = 0;
...
boost::filesystem::path static GetAutostartFilePath()
{
    ...
    return GetAutostartDir() / strprintf("qogecoin-%s.lnk", chain);
}
